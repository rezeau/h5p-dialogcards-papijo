 ...
 this.attach = ($container) => {  
  ...
  this.attachContinue = () => {
    ...
    if (this.matchIt && !this.sideBySide) {
      ...
      this.createFooter().appendTo(this.$inner);
    }
   ...
   * @returns {HTMLElement} Card content wrapper
   */
  this.createCardContentLeft = (card, cardNumber, setCardSizeCallback) => {    
