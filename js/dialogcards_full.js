...
H5P.DialogcardsPapiJo = (function ($, Audio, JoubelUI) {
   ...
   */
    ...
    if (this.enableGotIt) {
      ...
      //console.log('1263 self.dialogs.length = ' + self.dialogs.length + ' selectionIndex = ' +selectionIndex+' this.endOfStack = '+ this.endOfStack+ ' self.nbCards = '+self.nbCards);
